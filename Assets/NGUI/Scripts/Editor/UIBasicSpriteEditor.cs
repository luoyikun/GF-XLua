...
public class UIBasicSpriteEditor : UIWidgetInspector
{
	...
	protected override void DrawCustomProperties ()
	{
        ...
        else if (type == UISprite.Type.DoubleSliced)
        {
            if (serializedObject.targetObject is UITexture)
            {
                NGUIEditorTools.DrawBorderProperty("Border", serializedObject, "mBorder");
                NGUIEditorTools.DrawBorderProperty("DoubleBorder", serializedObject, "mDoubleBorder");
                NGUIEditorTools.DrawProperty("InsideSize", serializedObject, "mInsideSize");
                NGUIEditorTools.DrawProperty("Flip", serializedObject, "mFlip");
            }
            else
            {
                string text = string.Format("DoubleSliced Just Use in UITexture");
