...
public class UIScrollView : MonoBehaviour
{
	...
	public bool constrainOnDrag = true;
	...
	public bool iOSDragEmulation = false;

	/// <summary>
	/// Effect the scroll wheel will have on the momentum.
	/// </summary>

	public float scrollWheelFactor = 1.44f;

	/// <summary>
	/// How much momentum gets applied when the press is released after dragging.
	/// </summary>

	public float momentumAmount = 180f;
    ...
    public void SetShouldMoveValue(bool value)
    {
        mShouldMove = value;
    }
    /// <summary>
	...
	public void ResetPosition()
	{
		if (NGUITools.GetActive(this))
		{
			...
			mCalculatedBounds = false;
            //调用ResetPosition时可能没有更新UIPanel锚点，导致计算区域错误，这里让它强行更新一次
            mPanel.UpdateAnchors();
