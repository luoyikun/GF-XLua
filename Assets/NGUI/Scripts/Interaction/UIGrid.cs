...
public class UIGrid : UIWidgetContainer
{
    ...
    public static readonly System.Comparison<Transform> m_SortByName = SortByName;
    public static readonly System.Comparison<Transform> m_SortByNameInv = SortByNameInv;
    public static readonly System.Comparison<Transform> m_SortHorizontal = SortHorizontal;
    public static readonly System.Comparison<Transform> m_SortHorizontalInv = SortHorizontalInv;
    public static readonly System.Comparison<Transform> m_SortVertical = SortVertical;
    public static readonly System.Comparison<Transform> m_SortVerticalInv = SortVerticalInv;
    ...
    private List<Transform> GetChildListInternal(List<Transform> list, Transform myTrans)
    {
        ...
        {
            if (sorting == Sorting.Alphabetic) { if (inverted) list.Sort(m_SortByNameInv); else list.Sort(m_SortByName); }
            else if (sorting == Sorting.Horizontal) { if (inverted) list.Sort(m_SortHorizontalInv); else list.Sort(m_SortHorizontal); }
            else if (sorting == Sorting.Vertical) { if (inverted) list.Sort(m_SortVerticalInv); else list.Sort(m_SortVertical); }
	...
	{
		List<Transform> list = GetChildListPrivate();
	...
	public int GetIndex (Transform trans) { return GetChildListPrivate().IndexOf(trans); }
	...
	public void AddChild (Transform trans)
	{
		if (trans != null)
		{
			...
			ResetPosition(GetChildListPrivate());
		}
	}
    ...
    [HideInInspector]
    public bool StartUseAnimateSmoothly;
