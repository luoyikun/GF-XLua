...
//	  }
	...
	/// </summary>
    static private Camera[] s_CameraArray = new Camera[20];
	...
	static public Camera FindCameraForLayer (int layer)
	{
		...
		int camerasFound = Camera.GetAllCameras(s_CameraArray);
	...
	static public void NormalizeWidgetDepths (UIWidget[] list)
	{
		...
		if (size > 0)
		{
			Array.Sort(list, UIWidget.m_FullCompareFunc);
	...
	static public void NormalizePanelDepths ()
	{
		...
		if (size > 0)
		{
			Array.Sort(list, UIPanel.m_CompareFunc);
