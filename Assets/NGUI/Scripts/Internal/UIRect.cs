...
public abstract class UIRect : MonoBehaviour
{
    ...
    protected BetterList<UIRect> mChildren
    {
        get
        {
            if (mChildrenBuffer == null)
            {
                mChildrenBuffer = PSNGUITools.GetBetterListUIRect();
            }
            return mChildrenBuffer;
        }
    }
	...
	[System.NonSerialized] public int mUpdateFrame = -1;
    ...
    protected BetterList<UIRect> mChildrenBuffer;
    ...
    protected virtual void OnDestroy()
    {
        if (mChildrenBuffer != null)
        {
            PSNGUITools.ReleaseBetterListUIRect(mChildrenBuffer);
            mChildrenBuffer = null;
        }
    }
    /// <summary>
