...
public abstract class UITweener : MonoBehaviour
{
    ...
    static Keyframe mFrom = new Keyframe(0f, 0f, 0f, 0f);
    static Keyframe mTo = new Keyframe(1f, 1f, 1f, 1f);

    static Keyframe[] mKeyframes = new Keyframe[2];
	...
	static public T Begin<T> (GameObject go, float duration, float delay = 0f) where T : UITweener
	{
        ...
        mKeyframes[0] = mFrom;
        mKeyframes[1] = mTo;
        comp.animationCurve = new AnimationCurve(mKeyframes);
